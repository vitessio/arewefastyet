...
# Benchmark: tpcc-unsharded | Sharding: unsharded | Ref: main
set -euo pipefail
...
echo "    Benchmark: tpcc-unsharded"
echo "    Sharding:  unsharded"
${DC} up -d --wait etcd vtctld mysql-1001 tablet-1001 mysqld-exporter-1001 vtctld-init vtgate
...
${DC} up -d alloy-vtgate alloy-vttablet-1001 prom-vtgate prom-vttablet-1001
...
echo "==> Running benchmark (tpcc-unsharded, threads=42, tables=1, time=60s)..."
${DC} run --rm sysbench run

echo ""
echo "==> Benchmark complete."

${DC} stop alloy-vtgate alloy-vttablet-1001 prom-vtgate prom-vttablet-1001
