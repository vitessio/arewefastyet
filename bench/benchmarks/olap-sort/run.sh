...
# Benchmark: olap-sort | Sharding: sharded | Ref: b451c7e6f9035d3ad50e5eef219dc36cf7ca0474
set -euo pipefail
...
echo ""
echo "==> Building Vitess image (ref=b451c7e6f9035d3ad50e5eef219dc36cf7ca0474)..."
...
echo "==> Running benchmark (olap-sort, threads=16, tables=10, time=60s)..."
