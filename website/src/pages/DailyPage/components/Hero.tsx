    ...
    <section className="flex h-[60vh] pt-[8vh] items-center p-page">
      <div className="flex flex-col justify-start items-start gap-5 max-w-screen-md">
        ...
        <p className="md:my-6 leading-loose">
          ...
          time on <i>main</i>. On this page, you can find graphs that show you
          the results of all five macro benchmark workload over the last 30
          days. Click on a macro benchmark workload to see all the results for
          that workload.
        </p>
      </div>
    </section>
